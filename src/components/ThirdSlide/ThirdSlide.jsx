            ...
            <div className="row mt-5  pt-4">
               ...
               >
                  ...
                  <div className="box___border___">
                     ...
                     <div className="text___">
                        <p>
                           نصيب الفرد أو الالتزامات المالية من أكثر الأسباب الرفض
                           في التمويل الاجتماعي.{" "}
                        </p>
                        <p>
                           الالتزامات المالية القائمة على المقترض أو الكفيل أبرز
                           أسباب الرفض لتمويل العمل الحر.
                        </p>
                        <p>
                           {" "}
                           انخفاض ملحوظ وممتاز في عدد الطلبات المرفوضة في تمويل
                           منشآت
                        </p>
                     </div>
               ...
               >
                  ...
                  <div className="box___border___">
                     ...
                     <div className="text___">
                        <p>
                           . النظام لا يدعم القيم الفريدة مما يؤدي الى عدم دقة
                           المعلومات
                        </p>
                        <p>
                           . عدم اتاحة التعديل على النموذج مما ينتج عنه تعدد في
                           الرفض والإلغاء وهو مما يؤثر على تجربة العميل.
                        </p>
                     </div>
                     <div className="icons___">
                        <img src={frame} alt="" />
               ...
               >
                  ...
                  <div className="box___border___">
                     ...
                     <div className="text___">
                        <p>
                           . ارتفاع مؤشر الرضا في خدمتين مقابل ستة خدمات، انخفاض
                           طفيف في خدمة الخطاب المديونية وكشف الحساب، ولكن بمستوى
                           ممتاز مقارنة بالخدمة المقدمة، كذلك تسبب تعطل النظام في
                           حجب رؤية التقييم لباقي الخدمات.
                        </p>
                     </div>
                     <div className="icons___">
                        <img src={frame11} alt="" />
               ...
               >
                  ...
                  <div className="box___border___">
                     ...
                     <div className="text___">
                        <p>
                           . تعد إحصائيات الرموز من الأمور الجديدة المضافة لتحليل
                           مشاعل العملاء، كم يتضح لنا استمرارية استخدام التفاعل
                           الإيجابي من الرموز من قبل العملاء مع انخفاض ملحوظ في
                           استخدام الرموز السلبية.
                        </p>
                     </div>
                     <div className="icons___">
                        <img src={frame11} alt="" />
               ...
               >
                  ...
                  <div className="box___border___">
                     ...
                     <div className="text___">
                        <p>
                           . معادلة المؤشر الحالي تعتمد على أوزان متساوية للخدمات
                           فقط، وهو ما سيتم تعديله بالتعاون مع الإدارات المعنية.
                        </p>
                        <p>
                           . هناك خلل تقني أدى إلى حجب ظهور بعض المؤشرات لبعض
                           الخدمات في النظام السابق، مع خلل تقني في النظام الجديد
                           بأرقام وقراءات مختلفة تماماً جاري العمل على دراستها مع
                           الإدارة المعنية لوضع سياساتها الخاصة.
                        </p>
                     </div>
                     <div className="icons___">
                        <img src={frame11} alt="" />
               ...
               >
                  ...
                  <div className="box___border___">
                     ...
                     <div className="text___">
                        <p>
                           . تأثرت نسب الإقراض سلبًا لتزامن هذا الربع مع عطلتين
                           رسميتين
                        </p>
               ...
               >
                  ...
                  <div className="box___border___">
                     ...
                     <div className="text___">
                        <p>
                           . التكامل مع الإدارات لتسهيل العقبات للوصول لتجربة
                           العملاء التي نرجوها هو أولويتنا، نسعى لوضع الجميع على
                           نفس الصفحة لفهم العميل ومراقبة تصرفاته والتمركز حوله
                        </p>
                     </div>
                     <div className="icons___">
                        <img src={frame} alt="" />
                  ...
                  <div className="grid-container">
                     ...
                     <p>
                        تزويدنا بنصوص نتائج الإجراءات على طلبات العملاء في مرحلة
                        المعالجة ليتم تحسينها
                     </p>
                     </div>
                     ...
                     <p>
                        اعتماد سياسة تصنيف البلاغات وعكسها على CRM مشروع تطوير
                        تصنيفات البلاغات
                     </p>
                     </div>
                     ...
                     <p>
                        TATالتكامل مع إدارة العمليات في تطوير لوحة البيانات وتوضيح
                        نسبة صحة اعتراض العميل على الرفض
                     </p>
                     </div>
               ...
               >
                  ...
                  <div className="box___border___">
                     ...
                     <div className="text___">
                        <p>
                           التعمق في تصنيف الصعوبات لمعرفة مشاكل العميل وحلها
                           بالشكل المطلوب
                        </p>
                        <p>
                           {" "}
                           المشاكل التشغيلية والتقنية المتكررة تجعل ضرورة إعطاء
                           الأولوية لتحسين عمل الأنظمة واستجابتها لأعلى معايير
                           تجربة المستخدم وهو ما يسهل على العملاء رحلتهم
                        </p>
                     </div>
                     <div className="icons___">
                        <img src={frame} alt="" />
               ...
               >
                  ...
                  <div className="box___border___">
                     ...
                     <div className="text___">
                        <p>
                           . الاستفسارات الأعلى هي عن مرحلة طلب تمويل والسياسات
                           الائتمانية واللوائح وأسباب الرفض مشكلة تجربة مستخدم في
                           نظام (LEN)
                        </p>
                        <p>
                  ...
                  <div className="row-grid">
                     ...
                     <h4>
                        <span>بلاغ</span>77,031
                     </h4>
                     <h6 style={{ color: "red", marginBottom: "12px" }}>
                        إجمالي البلاغات
                     </h6>
                     <img src={svgicon} alt="" />
                     </div>
